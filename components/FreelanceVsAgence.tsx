  ...
  return (
    <section id="freelance-vs-agence" className="relative py-24 px-4">
      <div className="max-w-[900px] mx-auto text-center">
        ...
        <p
          ref={revealHeader(1)}
          className="text-[15px] sm:text-[18px] text-subdued mb-12 sm:mb-16 tracking-tight max-w-2xl mx-auto"
        >
          {t('comparison_subtitle')}
        </p>

        {/* Column headers — outside the card */}
        <div ref={revealHeader(2)} className="grid grid-cols-2 gap-4 sm:gap-8 mb-6 px-4 sm:px-10">
        ...
        {/* Comparison card */}
        <div ref={revealHeader(3)} className="irys-card p-4 sm:p-10 mb-14 text-left overflow-hidden relative">
